...
void dpisim_t::check_single(reg_t micro, reg_t isa, db_t* actual, const char *desc) {
   if (micro != isa) {
...
void dpisim_t::check_double(reg_t micro0, reg_t micro1, reg_t isa0, reg_t isa1, const char *desc) {
...
bool dpisim_t::check_state(state_t* micro_state, state_t* isa_state, db_t* actual) {
   bool fail = false;
...
//     // TODO: Add this check
//     assert(REN_INT->get_exception(PAY.buf[head].AL_index_int) == true);
//   }
